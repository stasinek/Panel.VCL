...
options.deskrect[0].bottom = options.clientrect.bottom  - 4;
 ...
 options.deskrect[1].right = options.deskrect[1].left   + (options.clientrect.right  - 16)/3;
...
options.deskrect[1].bottom = options.deskrect[1].top + options.clientrect.bottom - 4;
 ...
 options.deskrect[2].right = options.deskrect[2].left + (options.clientrect.right  - 16)/3;
...
options.deskrect[2].bottom = options.deskrect[1].bottom;
 ...
 options.deskrect[3].right = options.deskrect[3].left + (options.clientrect.right  - 16)/3;
...
{
if (options.clientrect.right==2*384+12 && options.clientrect.bottom==2*256+12)
   {MenuItemSize384->Checked  = true;
   }
else
if (options.clientrect.right==2*256+12 && options.clientrect.bottom==2*192+12)
   {MenuItemSize256->Checked  = true;
   }
else
if (options.clientrect.right==2*192+12 && options.clientrect.bottom==2*144+12)
   {MenuItemSize192->Checked  = true;
   }
else
if (options.clientrect.right==2*144+12 && options.clientrect.bottom==2*108+12)
   {MenuItemSize144->Checked  = true;
   }
else
if (options.clientrect.right==2*96+12 && options.clientrect.bottom==2*72+12)
   {MenuItemSize96->Checked   = true;
   }
else
if (options.clientrect.right==2*64+12 && options.clientrect.bottom==2*48+12)
   {MenuItemSize64->Checked   = true;
   }
else
if (options.clientrect.right==2*48+12 && options.clientrect.bottom==2*36+12)
   {MenuItemSize48->Checked   = true;
   }
else
if (options.clientrect.right==2*32+12 && options.clientrect.bottom==2*24+12)
...
{
options.clientrect.right = 3*24+16; options.clientrect.bottom = 24+8;
tform_Resize();
}
//---------------------------------------------------------------------------
...
{
options.clientrect.right = 3*48+12; options.clientrect.bottom = 48+8;
tform_Resize();
}
//---------------------------------------------------------------------------
...
{
options.clientrect.right = 3*64+12; options.clientrect.bottom = 64+8;
tform_Resize();
}
//---------------------------------------------------------------------------
...
{
options.clientrect.right = 3*96+12; options.clientrect.bottom = 96+8;
tform_Resize();
}
//---------------------------------------------------------------------------
...
{
options.clientrect.right = 3*144+12; options.clientrect.bottom = 144+8;
tform_Resize();
}
//---------------------------------------------------------------------------
...
{
options.clientrect.right = 3*192+12; options.clientrect.bottom = 192+8;
tform_Resize();
}
//---------------------------------------------------------------------------
...
{
options.clientrect.right = 3*256+12; options.clientrect.bottom = 256+8;
tform_Resize();
}
//---------------------------------------------------------------------------
...
{
options.clientrect.right = 3*384+12; options.clientrect.bottom = 384+8;
tform_Resize();
}
//---------------------------------------------------------------------------
